...
uint8_t led[] = {0xfe,0xfd,0xfb,0xf7,0xef,0xdf,0xbf,0x7f};   //led亮1~8
uint8_t seg[] ={0x01,0x02,0x04,0x08,0x10,0x20,0x40,0x80};    //数码管亮1~8
int i=0;
  ...
  ui32SysClock = SysCtlClockFreqSet((SYSCTL_XTAL_16MHZ |SYSCTL_OSC_INT |SYSCTL_USE_OSC), 16000000);		
	...
	while (1)
	{
		if(!GPIOPinRead(GPIO_PORTJ_BASE,GPIO_PIN_0))
			continue;
    result = I2C0_WriteByte(PCA9557_I2CADDR,PCA9557_OUTPUT,led[i]);	
		
		result = I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,seg[i]);					//write port 2
...
//	I2CMasterControl(I2C0_BASE, I2C_MASTER_CMD_BURST_SEND_START);		
	I2CMasterControl(I2C0_BASE,I2C_MASTER_CMD_SINGLE_SEND);//执行单次写操作
