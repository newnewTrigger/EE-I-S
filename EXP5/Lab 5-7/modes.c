...
// 模式0_0
void mode0_0(uint8_t* v_passin[], uint8_t* t_passin[], uint8_t* f_passin[]){ //ACT0
//    clear_screen();
...
// 模式1_0
void mode1_0(uint8_t* v_passin[], uint8_t* t_passin[], uint8_t* f_passin[]){ //ACT1,百位反白
    clear_screen();
...
// 模式1_1
void mode1_1(uint8_t* v_passin[], uint8_t* t_passin[], uint8_t* f_passin[]){ //ACT1,十位反白
    clear_screen();
    display_GB2312_string(1, 1, "载频:", 0);
...
// 模式1_2
void mode1_2(uint8_t* v_passin[], uint8_t* t_passin[], uint8_t* f_passin[]){  //ACT1,个位反白
    clear_screen();
    display_GB2312_string(1, 1, "载频:", 0);
    display_GB2312_string(1, 41, f_passin[0], 0);
    display_GB2312_string(1, 49, f_passin[1], 0);
...
// 模式1_3
void mode1_3(uint8_t* v_passin[], uint8_t* t_passin[], uint8_t* f_passin[]){ //ACT1,十分位反白
    clear_screen();
    display_GB2312_string(1, 1, "载频:", 0);
    display_GB2312_string(1, 41, f_passin[0], 0);
    display_GB2312_string(1, 49, f_passin[1], 0);
...
// 模式1_4
void mode1_4(uint8_t* v_passin[], uint8_t* t_passin[], uint8_t* f_passin[]){ //ACT1,确定键反白
    clear_screen();
    display_GB2312_string(1, 1, "载频:", 0);
    display_GB2312_string(1, 41, f_passin[0], 0);
    display_GB2312_string(1, 49, f_passin[1], 0);
...
// 模式2_0
void mode2_0(uint8_t* v_passin[], uint8_t* t_passin[], uint8_t* f_passin[]){ //ACT2，频率超范围
    clear_screen();
