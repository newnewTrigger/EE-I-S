...
struct Note melody[] = {
    {440, 45}, // A4，频率为440Hz，持续时间为500ms
	{659, 15}, // C5，频率为523Hz，持续时间为500ms
    {587, 15}, // B4，频率为494Hz，持续时间为500ms
    {659, 15}, // C5，频率为523Hz，持续时间为500ms
	{523, 15}, // A4，频率为440Hz，持续时间为500ms
    {494, 15}, // B4，频率为494Hz，持续时间为500ms
    {440, 120}, // C5，频率为523Hz，持续时间为500ms
